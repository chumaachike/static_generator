...
def recursive_copy(source=None, destination=None):
    if not source and not destination:
        source, destination = "./static/", "./docs"
...
def generate_pages_recursive(template_path, basepath, dir_path_content=None, dest_dir_path=None):
    if not dir_path_content and not dest_dir_path:
        dir_path_content, dest_dir_path = "./content", "./docs"
    ...
    for filename in os.listdir(dir_path_content):
        ...
        try:
            if os.path.isfile(file_path):
                ...
                generate_pages_recursive(template_path, basepath, file_path, new_dest_dir)
